...
class AppRouter extends _i46.RootStackRouter {
  ...
  final Map<String, _i46.PageFactory> pagesMap = {
    ...
    RemoteShopListScreenRoute.name: (routeData) {
      return _i46.AdaptivePage<dynamic>(
        routeData: routeData,
        child: const _i42.RemoteShopListScreen(),
      );
    },
...
class DebugWebShopTabsRouter extends _i46.PageRouteInfo<void> {
  const DebugWebShopTabsRouter({List<_i46.PageRouteInfo>? children})
      : super(
          DebugWebShopTabsRouter.name,
          path: 'web-shop',
          initialChildren: children,
...
class WebShopDetailScreenRoute
    extends _i46.PageRouteInfo<WebShopDetailScreenRouteArgs> {
...
class WebCollectionDetailScreenRoute
    extends _i46.PageRouteInfo<WebCollectionDetailScreenRouteArgs> {
