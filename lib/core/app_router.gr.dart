...
class AppRouter extends _i7.RootStackRouter {
  ...
  final Map<String, _i7.PageFactory> pagesMap = {
    ...
    ConfigContainerScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i5.ConfigContainerScreen());
    },
    ...
    SendScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i9.SendScreen());
    },
    ReceiveScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i10.ReceiveScreen());
    },
    TransactionsScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i11.TransactionsScreen());
    },
    ValidatorScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i12.ValidatorScreen());
    },
    AdjudicatorScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i13.AdjudicatorScreen());
    },
    NodeListScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i14.NodeListScreen());
    },
    DataNodeScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i15.DataNodeScreen());
    },
    NftListScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i16.NftListScreen());
    },
    SmartContractsScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i17.SmartContractsScreen());
    },
    DstsScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i18.DstsScreen());
    },
    AdnrScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i19.AdnrScreen());
    },
    TopicListScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i20.TopicListScreen());
    },
    TopicDetailScreenRoute.name: (routeData) {
      ...
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData,
          child:
              _i21.TopicDetailScreen(key: args.key, topicUid: args.topicUid));
    },
    CreateTopicScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i22.CreateTopicScreen());
    },
    BeaconListScreenRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i23.BeaconListScreen());
    },
    SmartContractCreatorMainRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i24.SmartContractCreatorMain());
    }
  };

  @override
  List<_i7.RouteConfig> get routes => [
        _i7.RouteConfig(RootContainerRoute.name, path: '/', children: [
          ...
          _i7.RouteConfig(SendTabRouter.name,
              path: 'send',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(SendScreenRoute.name,
                    path: '', parent: SendTabRouter.name)
              ]),
          _i7.RouteConfig(ReceiveTabRouter.name,
              path: 'receive',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(ReceiveScreenRoute.name,
                    path: '', parent: ReceiveTabRouter.name)
              ]),
          _i7.RouteConfig(TransactionsTabRouter.name,
              path: 'transactions',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(TransactionsScreenRoute.name,
                    path: '', parent: TransactionsTabRouter.name)
              ]),
          _i7.RouteConfig(ValidatorTabRouter.name,
              path: 'validator',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(ValidatorScreenRoute.name,
                    path: '', parent: ValidatorTabRouter.name)
              ]),
          _i7.RouteConfig(AdjudicatorTabRouter.name,
              path: 'adjudicator',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(AdjudicatorScreenRoute.name,
                    path: '', parent: AdjudicatorTabRouter.name)
              ]),
          _i7.RouteConfig(NodesTabsRouter.name,
              path: 'nodes',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(NodeListScreenRoute.name,
                    path: '', parent: NodesTabsRouter.name)
              ]),
          _i7.RouteConfig(DatanodeTabRouter.name,
              path: 'datanode',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(DataNodeScreenRoute.name,
                    path: '', parent: DatanodeTabRouter.name)
              ]),
          _i7.RouteConfig(NftTabRouter.name,
              path: 'nft',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(NftListScreenRoute.name,
                    path: '', parent: NftTabRouter.name)
              ]),
          _i7.RouteConfig(SmartContractsTabRouter.name,
              path: 'smart-contracts',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(SmartContractsScreenRoute.name,
                    path: '', parent: SmartContractsTabRouter.name)
              ]),
          _i7.RouteConfig(DstsTabRouter.name,
              path: 'dsts',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(DstsScreenRoute.name,
                    path: '', parent: DstsTabRouter.name)
              ]),
          _i7.RouteConfig(AdnrTabRouter.name,
              path: 'adnr',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(AdnrScreenRoute.name,
                    path: '', parent: AdnrTabRouter.name)
              ]),
          _i7.RouteConfig(VotingTabRouter.name,
              path: 'voting',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(TopicListScreenRoute.name,
                    path: '', parent: VotingTabRouter.name),
                _i7.RouteConfig(TopicDetailScreenRoute.name,
                    path: ':uid', parent: VotingTabRouter.name),
                _i7.RouteConfig(CreateTopicScreenRoute.name,
                    path: 'create', parent: VotingTabRouter.name)
              ]),
          _i7.RouteConfig(BeaconTabRouter.name,
              path: 'beacons',
              parent: RootContainerRoute.name,
              children: [
                _i7.RouteConfig(BeaconListScreenRoute.name,
                    path: '', parent: BeaconTabRouter.name)
              ])
        ]),
        _i7.RouteConfig(MySmartContractsScreenRoute.name,
            path: 'my-smart-contracts'),
        _i7.RouteConfig(SmartContractDraftsScreenRoute.name,
            path: 'smart-contract-drafts'),
        _i7.RouteConfig(TemplateChooserScreenRoute.name,
            path: 'smart-contract-templates'),
        _i7.RouteConfig(ConfigContainerScreenRoute.name, path: 'config'),
        _i7.RouteConfig(SmartContractCreatorContainerScreenRoute.name,
            ...
            children: [
              _i7.RouteConfig('#redirect',
                  ...
                  redirectTo: 'main',
                  fullMatch: true),
              _i7.RouteConfig(SmartContractCreatorMainRoute.name,
                  path: 'main',
                  parent: SmartContractCreatorContainerScreenRoute.name)
            ])
      ];
...
class ConfigContainerScreenRoute extends _i7.PageRouteInfo<void> {
...
class TopicDetailScreenRoute
  ...
  TopicDetailScreenRoute({_i26.Key? key, required String topicUid})
