                        ...
                        return AppButton(
                          ...
                          onPressed: () async {
                            final confirmed = await ConfirmDialog.show(
                              ...
                              body: "There is a cost of 4.0 RBX to activate your reserve account which is burned.\nContinue?",
                            ...
                            final signature =
                                await RawTransaction.getSignature(message: hash, privateKey: keypair.private, publicKey: keypair.public);
                            if (signature == null) {
