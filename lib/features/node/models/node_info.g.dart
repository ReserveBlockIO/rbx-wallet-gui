...
_$_NodeInfo _$$_NodeInfoFromJson(Map<String, dynamic> json) => _$_NodeInfo(
      ...
      lastCheked: json['NodeLastChecked'] == null ? null : DateTime.parse(json['NodeLastChecked'] as String),
    );

Map<String, dynamic> _$$_NodeInfoToJson(_$_NodeInfo instance) => <String, dynamic>{
      'NodeIP': instance.ip,
