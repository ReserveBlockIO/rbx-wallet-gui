...
import 'package:rbx_wallet/features/smart_contracts/providers/sc_wizard_log_visible_provider.dart';
                                      ...
                                      child: AppButton(
                                        ...
                                        onPressed: () async {
                                          if (kIsWeb) {
                                            ...
                                            ref.read(scWizardLogVisibleProvider.notifier).start();
                                          }
                                          ...
                                          if (kIsWeb) {
                                            ...
                                            ref.read(scWizardLogVisibleProvider.notifier).complete();
                                          }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 400,
                height: 300,
                decoration: BoxDecoration(color: Colors.black87, boxShadow: glowingBox),
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: ListView.builder(
                    controller: ref.read(scWizardLogProvider.notifier).scrollController,
