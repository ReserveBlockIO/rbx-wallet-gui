...
_$_Ticket _$$_TicketFromJson(Map<String, dynamic> json) => _$_Ticket(
      ...
      type: $enumDecodeNullable(_$TicketTypeEnumMap, json['type']) ?? TicketType.physicalEvent,
      ...
      expireDate: json['expireDate'] == null ? null : DateTime.parse(json['expireDate'] as String),
    );
